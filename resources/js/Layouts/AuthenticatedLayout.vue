                    ...
                    <div class="flex h-16 justify-between">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                ...
                                <div v-if="isAdmin" class="space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                    <NavLink :href="route('dashboard')" :active="route().current('dashboard')">
                                        Dashboard
                                    </NavLink>

                                    <NavLink :href="route('itemmanagement')"
                                        :active="route().current('itemmanagement')">
                                        Item Management
                                    </NavLink>
                                    <NavLink :href="route('borrowrequest')" :active="route().current('borrowrequest')">
                                        Borrowing Request
                                    </NavLink>
                                    <NavLink :href="route('borrowhistory')" :active="route().current('borrowhistory')">
                                        Borrowing History
                                    </NavLink>


                                    <NavLink :href="route('officeinventory')"
                                        :active="route().current('officeinventory')">
                                        Office Inventory
                                    </NavLink>
                                    <NavLink :href="route('officerequest')" :active="route().current('officerequest')">
                                        Office Request
                                    </NavLink>
                                </div>
                                <div v-if="isUser" class="space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                    <NavLink :href="route('items')" :active="route().current('items')">
                                        Items
                                    </NavLink>
                                    <NavLink :href="route('borroweditem')" :active="route().current('borroweditem')">
                                        Borrowed Items
                                    </NavLink>
                                </div>

                                <div v-if="isOffice" class="space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                    <NavLink :href="route('inventory')" :active="route().current('inventory')">
                                        Inventory
                                    </NavLink>
                                    <NavLink :href="route('purchaserequest')"
                                        :active="route().current('purchaserequest')">
                                        Purchase Request
                                    </NavLink>
                                    <NavLink :href="route('requesthistory')"
